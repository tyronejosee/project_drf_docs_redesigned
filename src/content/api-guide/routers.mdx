---
title: "Routers"
keywords: ["django", "rest", "framework", "api", "routers"]
order: 6
---
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>GET, or as specified by `methods`</td>
...
For another example of setting the `.routes` attribute, see the source code for the
`SimpleRouter` class.
