...
keywords: ["django", "rest", "framework", "api", "project", "management"]
order: 4
---
...
- [ ] Create pull request for [release notes](https://github.com/encode/django-rest-framework/blob/master/docs/topics/release-notes.md) based on the [_._.\* milestone](https://github.com/encode/django-rest-framework/milestones/***).
