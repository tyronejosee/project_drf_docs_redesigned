---
title: "Validators"
keywords: ["django", "rest", "framework", "api", "validators"]
order: 11
---
...
For this purposes use `HiddenField`. This field will be present in `validated_data` but _will not_ be used in the serializer output representation.
