...
```bash
http -a admin:tucontraseña POST http://127.0.0.1:8000/snippets/ code="print(789)"
...
Ahora tenemos un conjunto completo de permisos en nuestra API web, y endpoints para los usuarios del sistema y para los fragmentos de código que han creado.
