...
Actualmente, las relaciones dentro de nuestra API se representan mediante claves primarias. En esta parte del tutorial, mejoraremos la cohesión y la capacidad de descubrimiento de nuestra API utilizando hipervínculos para las relaciones.
...
Manejar las relaciones entre entidades es uno de los aspectos más complejos del diseño de APIs web. Hay varias formas diferentes en que podríamos elegir representar una relación:
