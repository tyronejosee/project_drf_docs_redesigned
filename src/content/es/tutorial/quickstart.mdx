...
Si es necesario, podemos descomponerlas fácilmente en vistas individuales, pero el uso de viewsets mantiene la lógica de las vistas bien organizada y muy concisa.
